...
def search(face_landmarks):
    ...
    return results
def complete_tranfomation_matrix(img, landmark, normalize, target_face_scale=1.0):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_url", type=str, default="home/jingjiao/ziyuwan/celebrities_detected_face_reid", help="output"
    )
